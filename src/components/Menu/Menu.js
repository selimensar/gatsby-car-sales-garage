...
export const Menu = () => {
  ...
  return (
    <div className=" sticky top-0 z-20 flex h-16 items-center justify-between bg-gradient-to-tr from-turkish-racing-green to-emerald-900 px-4 font-bold text-white">
      <div>
        <Link to="/">
          <StaticImage
            src="../../../static/icon.png"
        ...
        {(menuItems || []).map((menuItem, index) => (
          ...
          >
            ...
            {!!menuItem.subMenuItems?.length && (
              <div className="absolute top-full right-0 hidden bg-emerald-800 text-right no-underline  group-hover:block">
